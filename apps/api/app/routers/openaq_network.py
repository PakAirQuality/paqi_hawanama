#!/usr/bin/env python3
"""
OpenAQ export for the PAQI AirVisual network.
...
# You can switch this to providers.code if you prefer.
...
# Adjust units if needed to match how your data is stored.
POLLUTANTS = [
    ("pm25", "µg/m³"),
    ("pm10", "µg/m³"),
    ("no2", "ppb"),
